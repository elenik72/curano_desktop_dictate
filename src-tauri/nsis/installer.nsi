; Custom NSIS template for Curano AI Dictate with portable mode support.
...
Function .onInit
  ...
  ; or the legacy empty marker created by older upstream releases. Require Data/
  ...
  ${AndIf} ${FileExists} "$INSTDIR\portable"
    ...
    FileRead $1 $2
    FileClose $1
    ${If} $2 == "Curano AI Dictate Portable Mode"
      StrCpy $PortableMode 1
    ${OrIf} $2 == ""
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "Curano AI Dictate Portable Mode"
    FileClose $0
